...
<template>
    <div class="mt-12">
        <div class="flex justify-end m-2 p-2">
            <RouterLink :to="{name:'ContactCreate'}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded">New Skill</RouterLink>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="contact in contacts" :key="contact.id">
                        ...
                        <td class="py-4 px-6">
                            Edit/Delete
                            <!-- <a href="#" class="font-medium text-blue-900 dark:text-blue-500 hover:underline">Edit</a> -->
                        </td>
                    </tr>
                </tbody>
            </table>
